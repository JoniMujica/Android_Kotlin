...
class Cliente(nombre:String, apellido:String, edad:Int, domicilio:String, var sexo:Char,
              var telefono:String, var cuenta:Cuenta) : Persona(nombre, apellido, edad, domicilio){
